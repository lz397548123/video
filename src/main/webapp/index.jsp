...
<div style="width: 100%;">
    <div class="layui-carousel lunbotuDiv" id="test1" lay-filter="test1">
        <div carousel-item>
            <div>
                <a href="javascript:">
                    <img src="file/video/images/轮播图/1.jpg" width="100%" height="400px" alt="1">
                </a>
            </div>
            <div>
                <a href="javascript:">
                    <img src="file/video/images/轮播图/2.jpg" alt="2" width="100%" height="400px">
                </a>
            </div>
            <div>
                <a href="javascript:">
                    <img src="file/video/images/轮播图/3.jpg" alt="3" width="100%" height="400px">
                </a>
            </div>
            <div>
                <a href="javascript:">
                    <img src="file/video/images/轮播图/4.jpg" alt="4" width="100%" height="400px">
                </a>
            </div>
            <div>
                <a href="javascript:">
                    <img src="file/video/images/轮播图/5.jpg" alt="5" width="100%" height="400px">
                </a>
            </div>
        </div>
        <a name="skip"></a>
    ...
    <div class="movie-container selectDiv">
        ...
        <ul class="selectList" id="select2">
            <span>类型：</span>
            <li style="background: #4EBBF9"><a href="javascript:void (0);" style="color: #fff;" categoryId="0">全部</a>
            </li>
        </ul>
        <hr>
