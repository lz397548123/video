...
<style type="text/css">
    body .login-class .layui-layer-title {
        font-size: 20px;
        color: #000;
    }

    body .login-class .layui-layer-btn a {
        background: #333;
    }

    body .login-class .layui-layer-btn .layui-layer-btn1 {
        background: #999;
    }
</style>
<%--顶部--%>
<div class="movie-header all-container">
    <div class="layui-container" style="width: 80%;">
        ...
        <a href="index.jsp" style="position: relative">
            ...
            <span class="movie-logo-font">liang</span>
        </a>
    ...
    --%>
            <button type="button" class="layui-btn layui-btn-normal" onclick="showSearchTip()"
                    style="vertical-align: middle;border-bottom-right-radius: 5px;border-top-right-radius: 5px; ">
