                    ...
                    <form action="user/update" method="post">
                        ...
                        <div>
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="birthday" value="${sessionScope.user.birthday}" class="input"
                ...
                <div class="layui-tab-item">
                    ...
                    <c:if test="${fn:length(collections) != 0}">
                        ...
                        <c:forEach var="collection" items="${collections}" varStatus="vs">
                            ...
                            <li>
                                <a href="video/detail/${collection.id}" target="_blank" class="img-block"><img
                                        src="${collection.imgSrc}" alt=""></a>
                                <a href="video/detail/${collection.id}" target="_blank"
                                   class="name-block">${collection.name}</a>
                            </li>
                                ...
                                <li class="layui-timeline-item">
                                    ...
                                    <div class="layui-timeline-content layui-text">
                                        <div class="layui-timeline-title">
                                            <a href="video/detail/${history.vid}" target="_blank"><img
                                                    src="${history.img}" height="140px" width="100px"
                                                    style="vertical-align: middle"></a>
                                            <div style="display: inline-block;margin-left: 10px;height: 140px;vertical-align: middle;">
                                                <a href="video/detail/${history.vid}" style="text-decoration: none;"
                                                   target="_blank"><h3>${history.name}</h3></a>
